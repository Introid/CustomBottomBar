package com.uigitdev.custombottombar.uigitdev.design.adapter;
...
import com.uigitdev.custombottombar.R;
import com.uigitdev.custombottombar.model.CustomBottomItem;
import com.uigitdev.custombottombar.uigitdev.design.viewholder.ItemViewHolder;
...
public class ItemAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private ItemSelectorInterface itemSelectorInterface;

    public ItemAdapter(int defaultOpenIndex, ArrayList<CustomBottomItem> items, ItemSelectorInterface itemSelectorInterface) {
        this.items = items;
